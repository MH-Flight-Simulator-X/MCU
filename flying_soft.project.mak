...
$(OUTPUT_DIR)/project/adc_reader.o: scr/adc_reader.c
	@$(POSIX_TOOL_PATH)echo 'Building adc_reader.c'
	@$(POSIX_TOOL_PATH)mkdir -p $(@D)
	$(ECHO)$(CC) $(CFLAGS) -c -o $@ scr/adc_reader.c
CDEPS += $(OUTPUT_DIR)/project/adc_reader.d
OBJS += $(OUTPUT_DIR)/project/adc_reader.o

$(OUTPUT_DIR)/sdk/platform/emlib/src/em_adc.o: $(COPIED_SDK_PATH)/platform/emlib/src/em_adc.c
	@$(POSIX_TOOL_PATH)echo 'Building $(COPIED_SDK_PATH)/platform/emlib/src/em_adc.c'
	@$(POSIX_TOOL_PATH)mkdir -p $(@D)
